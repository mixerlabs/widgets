...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # This does not work yet. It's a "TODO" in the south code.
##         db.alter_column('widgets_wikipage', 'slug',
##                         models.SlugField(max_length=400, unique=False))
        db.delete_unique('widgets_wikipage', ('slug',))
