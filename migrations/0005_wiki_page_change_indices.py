...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # This should ideally be a descending index. It doesn't seem
        # like sotuh supports it. If it's an actual issue, we should
        # break out some SQL.
        db.create_index('widgets_wikipagechange', ['changed_on'])
    
    def backwards(self, orm):
        "Write your backwards migration here"
        db.delete_index('widgets_wikipagechange', ['changed_on'])
