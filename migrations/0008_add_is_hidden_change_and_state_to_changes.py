...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WikiPageChange.is_hidden_change'
        db.add_column('widgets_wikipagechange', 'is_hidden_change', orm['widgets.WikiPageChange:is_hidden_change'])
        
        # Adding field 'WikiPageChange.state'
        db.add_column('widgets_wikipagechange', 'state', orm['widgets.WikiPageChange:state'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'WikiPageChange.is_hidden_change'
        db.delete_column('widgets_wikipagechange', 'is_hidden_change')
        
        # Deleting field 'WikiPageChange.state'
        db.delete_column('widgets_wikipagechange', 'state_id')
    ...
    models = {
        ...
        'widgets.wikihome': {
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '400', 'unique': 'True', 'db_index': 'True'})
        },
        'widgets.wikipage': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '400', 'db_index': 'True'}),
        ...
        'widgets.wikipagechange': {
            ...
            'changed_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_hidden_change': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['widgets.WikiPage']"}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['widgets.WidgetState']", 'null': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'})
        }
    }
